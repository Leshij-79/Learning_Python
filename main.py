...
if __name__ == "__main__":
    ...
    if choise_sort_day == 'да' or choise_sort_day == 'д':
        while True:
            ...
            if (choise_sort_day_ == 'да' or choise_sort_day_ == 'д' or
                    choise_sort_day_ == 'нет' or choise_sort_day_ == 'н'):
                break
    ...
    while True:
        ...
        if (choise_operation_rub == 'да' or choise_operation_rub == 'д' or
                choise_operation_rub == 'нет' or choise_operation_rub == 'н'):
            break

    if choise_operation_rub == 'да' or choise_operation_rub == 'д':
        generator_operations = filter_by_currency(data_before_choosing_operations,'RUB')
    else:
    ...
    while True:
        choise_sort_word = input('Отфильтровать список транзакций по определенному слову '
                                'в описании? Да/Нет (Д/н)').lower()
    ...
    if choise_sort_word == 'да' or choise_sort_word == 'д':
        ...
        result = process_bank_search(generator_operations, choise_sort_word)
    else:
