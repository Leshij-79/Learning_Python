...
@pytest.mark.parametrize('test_card_number, expected', [
...
def test_get_mask_card_number(test_card_number: str, expected: str):
    assert get_mask_card_number(test_card_number) == expected

@pytest.mark.parametrize('test_account_number, expected', [
...
def test_get_mask_account(test_account_number: str, expected: str):
