...
def test_filter_by_state_first(fixture_test_filter_by_state: list, test_name_state: str, expected: list) -> list:
...
def test_filter_by_state_second(test_name_state: str, expected: list) -> list:
...
def test_sort_by_date_first(fixture_test_filter_by_date_first: list, test_reverse: bool, expected_date: list) -> list:
...
def test_sort_by_date_first_second(fixture_test_filter_by_date_second: list, test_reverse: bool, expected_date: list) -> list:
...
def test_sort_by_date_first_third(list_by_filter: list, test_reverse: bool, expected_date: list) -> list:
