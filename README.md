...
filter_by_currency - Фильтрация транзакций по заданной валюте в файле json
Принимает на входе список словарей транзакций и возвращает через генератор записи по заданной валюте

filter_by_currency_csv_excel - Фильтрация транзакций по заданной валюте в файле csv и excel
Принимает на входе список словарей транзакций и возвращает через генератор записи по заданной валюте
...
read_transaction_csv - Функция чтения данных по транзакциям из csv-файла
Принимает на вход путь к csv-файлу в формате str и разделитель данных в csv-файле в формате str. 
По-умолчанию ',' 
Возвращает данные в формате список словарей

read_transaction_excel - Функция чтения данных транзакций из xlsx-файла
Принимает на вход путь к xlsx-файлу в формате str
Возвращает данные в формате список словарей

process_bank_search - Функция поиска данных в списке банковских операций в описании 
операции
Принимает на вход список словарей с данными о банковских операциях и строку поиска
Возвращает список словарей банковских операций, у которых в описании есть данная строка

process_bank_operations - Функция подсчёта количества операций по заданным категориям
Принимает на вход список словарей с данными о банковских операциях ис список категорий 
операций
Возвращает словарь, в котором ключи — это названия категорий, а значения — это количество 
операций в каждой категории

##Логирование
Реализовано логирование модулей masks и utils
...
Возвращает результат выполнения функции либо None в случае возникновения ошибки при 
выполнении функции
